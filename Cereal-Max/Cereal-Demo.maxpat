...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 191.75, 214.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 75.25, 214.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 17.0, 185.0, 252.0, 22.0 ],
					"text" : "route pot button scaled raw"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "Cereal-Parser.maxpat",
				"bootpath" : "~/GitHub/Cereal-Library/Cereal-Max",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}

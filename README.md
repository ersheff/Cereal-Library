...
2. When connecting buttons or switches to digital inputs, be aware that the mode for digital pins is set to INPUT_PULLUP instead of INPUT. This means that the other side of your button/switch should be connected to GND instead of 5V (many example diagrams likely show the latter). Yours should look like this:
